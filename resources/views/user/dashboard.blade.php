<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2
                class="font-bold text-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 bg-clip-text text-transparent">
                {{ __('My Dashboard') }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="bg-green-50 rounded-xl p-4 border border-green-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-green-900">৳{{ number_format($payment_stats['total_paid'], 2) }}</p>
                            </div>
                    ...
                    <!-- Amount Due -->
                    <div class="bg-{{ $amount_due > 0 ? 'red' : 'green' }}-50 rounded-xl p-4 border border-{{ $amount_due > 0 ? 'red' : 'green' }}-200">
                        <div class="flex items-center justify-between">
                            <div>
                            ...
                            <div class="bg-{{ $amount_due > 0 ? 'red' : 'green' }}-100 rounded-full p-2">
                                <svg class="w-6 h-6 text-{{ $amount_due > 0 ? 'red' : 'green' }}-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between bg-gray-50 rounded-lg px-4 py-3 hover:bg-gray-100 transition-colors duration-200">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($payment->date)->format('M d, Y') }}</p>
                                </div>
                            </div>
                            @if($payment->notes)
                ...
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-200">
                    ...
                    <div class="space-y-3">
                         <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-green-600">৳{{ number_format($payment_stats['total_paid'], 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Total Meals Cost</span>
                            <span class="font-bold text-gray-900">-৳{{ number_format($total_meal * $cost_per_meal, 2) }}</span>
                        </div>
                        ...
                        <div class="border-t border-gray-300 pt-2">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-xl font-bold {{ $amount_due > 0 ? 'text-red-600' : 'text-green-600' }}">
                                    ৳{{ number_format(abs($amount_due), 2) }}
                                </span>
                            </div>
                        </div>
